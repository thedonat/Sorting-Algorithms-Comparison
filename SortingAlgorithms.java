...
public class SortingAlgorithms {
    ...
    public void summaryofSortingAlgorithms() {
        ...
        System.out.println("Using Bubble Sort It took -> " + this.durations[0]);
        System.out.println("Using Selection Sort It took -> " + this.durations[1]);
        System.out.println("Using Insertion Sort It took -> " + this.durations[2]);
        System.out.println("Using Merge Sort It took -> " + this.durations[3]);
        System.out.println("Using Quick Sort It took -> " + this.durations[4]);
        System.out.println("Using Heap Sort It took -> " + this.durations[5]);
        System.out.println("Using Counting Sort It took -> " + this.durations[6]);
        System.out.println("Using Radix Sort It took -> " + this.durations[7]);
        System.out.println(" ");
        System.out.println("Acording to the given imput the most successful algorithm is Counting Sort");
    }
}
